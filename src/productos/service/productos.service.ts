...
import { MaceterosService } from './maceteros.service';
...
import { FertilizantesService } from 'src/productos/service/fertilizantes.service';
  ...
  constructor(
    ...
    this.productos = [
      new Producto(
        1,
        'Aceite de neem',
        ['https://autoherb.cl/producto/aceite-neem/'],
        0,
        5000,
        ['Arica a Pta.Arenas'],
        100,
        'Aceite para el control de plagas como pulgones, cochinillas y ácaros.',
      ...
      new Producto(
        ...
        'Jabón potásico',
        [
          'https://www.jumbo.cl/jabon-potasico-popeye-ecofriendly-1-l-1901730/p?idsku=117690&gad_source=1&gclid=Cj0KCQjww5u2BhDeARIsALBuLnPffNH36xHASuTqi98qIqqiz7N_GOLKxuLmhU7hGgN6gBUbQgV1O_4aAgH8EALw_wcB&gclsrc=aw.ds',
        ],
        0,
        3000,
        ['Arica a Pta.Arenas'],
        150,
        'Jabón potásico para control de pulgones, mosca blanca y cochinillas.',
        TipoProductos.ControlPlagas,
        4.2,
        30,
        'CP2',
      ...
      new Producto(
        ...
        'Tierra de diatomeas',
        [
          'https://www.deraizchile.cl/products/diatomeas-jardines-y-fertilizantes?variant=40835675259062&currency=CLP&utm_medium=product_sync&utm_source=google&utm_content=sag_organic&utm_campaign=sag_organic&gad_source=1&gclid=Cj0KCQjww5u2BhDeARIsALBuLnPvAS6Eb97Wl4miGn-B-HeFm6nRTFNtATS0-mP-MKIdWWhQ7y9eitwaAgwFEALw_wcB',
        ],
        0,
        8000,
        ['Arica a Pta.Arenas'],
        120,
        'Polvo de silicio para control de hormigas, cochinillas y pulgones.',
        TipoProductos.ControlPlagas,
        4.7,
        40,
        'CP3',
      ...
      new Producto(
        ...
        'Fungicida de azufre',
        [
          'https://tiendachagual.cl/producto/sulforte-500ml-chakrana/?utm_source=Google%20Shopping&utm_campaign=Productos%20Chagual%202022&utm_medium=cpc&utm_term=68050&gad_source=1&gclid=Cj0KCQjww5u2BhDeARIsALBuLnOSrPBfmZhyKTaVJCwCxewtoNwJWqUJCVBGF_6mf6ujxECLzIBLgGkaApoMEALw_wcB',
        ],
        0,
        7000,
        ['Arica a Pta.Arenas'],
        80,
        'Azufre micronizado para hongos como mildiu y oídio.',
        TipoProductos.ControlPlagas,
        4.4,
        60,
        'CP4',
      ...
      new Producto(
        ...
        [
          'https://www.amazon.com/-/es/Fertiloma-16042-Aceite-horticultura-Listado/dp/B0BLRLCB9N',
        ],
        0,
        6000,
        ['Arica a Pta.Arenas'],
        90,
        'Aceite mineral para el control de ácaros, cochinillas y escamas.',
        TipoProductos.ControlPlagas,
        4.6,
        35,
        'CP5',
      ...
      new Producto(
        6,
        'Fertilizante equilibrado 20-20-20',
        ['https://whenua.cl/products/mix-full-jardin?variant=44250285670678'],
        0,
        6490,
        ['Arica a Pta.Arenas'],
        50,
        'Fertilizante equilibrado con NPK 20-20-20 para plantas de interior.',
      ...
      new Producto(
        7,
        'Fertilizante líquido para follaje',
        [
          'https://bestgarden.cl/fertilizantes/23-fertilizante-follaje-y-floracion-listo-para-usar-1lt-7804630000903.html',
        ],
        0,
        2490,
        ['Arica a Pta.Arenas'],
        80,
        'Fertilizante líquido especializado para plantas de follaje.',
        TipoProductos.Fertilizantes,
        4.5,
        95,
        'FE2',
      ...
      new Producto(
        8,
        'Fertilizante balanceado 10-10-10',
        ['https://www.plantin.cl/product-page/npk-granulado'],
        0,
        1990,
        ['Arica a Pta.Arenas'],
        60,
        'Fertilizante granulado balanceado con NPK 10-10-10 para plantas de interior.',
        TipoProductos.Fertilizantes,
        4.3,
        70,
        'FE3',
      ...
      new Producto(
        ...
        [
          'https://tiendachagual.cl/producto/fertilizante-organico-mix-full/?utm_source=Google%20Shopping&utm_campaign=Productos%20Chagual%202022&utm_medium=cpc&utm_term=35101&gad_source=1&gclid=Cj0KCQjww5u2BhDeARIsALBuLnOcY7WGdjzwd0qg5DGf-FTyDIK34eUea2IXNJST8pYpKmmw0UbSpCYaArCQEALw_wcB',
        ],
        0,
        7500,
        ['Arica a Pta.Arenas'],
        40,
        'Fertilizante orgánico granular para plantas en general.',
        TipoProductos.Fertilizantes,
        4.6,
        90,
        'FE4',
      ...
      new Producto(
        ...
        [
          'https://www.sodimac.cl/sodimac-cl/articulo/110132792/Fertilizante-para-cactus-y-suculentas-200-gr-bolsa/110132793?kid=goosho_373415&shop=googleShopping&gad_source=1&gclid=Cj0KCQjww5u2BhDeARIsALBuLnPwkZa67TWdg8rQbU0e6r2ncQaou4VHDaBCt0LpyXiCNPLS-NHCFtUaAi7vEALw_wcB',
        ],
        0,
        1990,
        ['Arica a Pta.Arenas'],
        90,
        'Evitar el exceso para prevenir quemaduras en raíces.',
        TipoProductos.Fertilizantes,
        4.4,
        130,
        'FE5',
      ...
      new Producto(
        11,
        'Macetero de plástico redondo 40 cm',
        [
          'https://www.sodimac.cl/sodimac-cl/product/267970X/Macetero-circular-plastico-40-cm-Gris/267970X',
        ],
        10,
        14990,
        ['Arica a Pta.Arenas'],
        20,
        'Macetero redondo de plástico, ideal para interiores y exteriores.',
      ...
      new Producto(
        28,
        'Macetero cerámica grande',
        ['https://www.paris.cl/macetero-de-ceramica-grande-955204999.html'],
        15,
        24990,
        ['Arica a Pta.Arenas'],
        10,
        'Macetero de cerámica de diseño moderno.',
        TipoProductos.Macetero,
        4.7,
        80,
        'MA2',
      ...
      new Producto(
        29,
        'Macetero colgante fibra natural',
        [
          'https://www.falabella.com/falabella-cl/product/881594174/Macetero-colgante-de-fibra-natural/881594174',
        ],
        5,
        9990,
        ['Arica a Pta.Arenas'],
        30,
        'Macetero colgante de fibra natural.',
        TipoProductos.Macetero,
        4.2,
        120,
        'MA3',
      ...
      new Producto(
        30,
        'Macetero metálico con soporte',
        [
          'https://www.easy.cl/tienda/producto/macetero-metal-con-soporte-urban-xl-negro-1282984',
        ],
        20,
        29990,
        ['Arica a Pta.Arenas'],
        5,
        'Macetero de metal con soporte de madera.',
        TipoProductos.Macetero,
        4.8,
        50,
        'MA4',
      ...
      new Producto(
        31,
        'Macetero cuadrado de cemento',
        [
          'https://www.sodimac.cl/sodimac-cl/product/1154031/Macetero-cemento-cubo-35x35-cm-Gris/1154031',
        ],
        12,
        18990,
        ['Arica a Pta.Arenas'],
        15,
        'Macetero de cemento con acabado rústico.',
        TipoProductos.Macetero,
        4.6,
        60,
        'MA5',
      ...
      new Producto(
        32,
        'Sustrato Universal Nutritivo',
        [
          'https://sodimac.scene7.com/is/image/SodimacCL/4764071?wid=800&hei=800&qlt=70',
        ],
        0,
        4990,
        ['Arica a Pta.Arenas'],
        50,
        'Sustrato universal ideal para todo tipo de plantas.',
      ...
      new Producto(
        ...
        [
          'https://sodimac.scene7.com/is/image/SodimacCL/4784856?wid=800&hei=800&qlt=70',
        ],
        0,
        2990,
        ['Arica a Pta.Arenas'],
      ...
      new Producto(
        ...
        [
          'https://sodimac.scene7.com/is/image/SodimacCL/4764075?wid=800&hei=800&qlt=70',
        ],
        0,
        5990,
        ['Arica a Pta.Arenas'],
        40,
        'Sustrato especial para el cultivo de orquídeas.',
        TipoProductos.Sustratos,
        4.7,
        800,
        'SU3',
      ...
      new Producto(
        ...
        [
          'https://sodimac.scene7.com/is/image/SodimacCL/4764084?wid=800&hei=800&qlt=70',
        ],
        0,
        7990,
        ['Arica a Pta.Arenas'],
        25,
        'Sustrato para el cultivo de hortalizas en huertos urbanos.',
        TipoProductos.Sustratos,
        4.6,
        1200,
        'SU4',
      ...
      new Producto(
        ...
        [
          'https://sodimac.scene7.com/is/image/SodimacCL/4764068?wid=800&hei=800&qlt=70',
        ],
        0,
        8990,
        ['Arica a Pta.Arenas'],
        20,
        'Sustrato especializado para bonsáis.',
        TipoProductos.Sustratos,
        4.9,
        600,
        'SU5',
