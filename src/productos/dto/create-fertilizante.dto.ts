...
export class CreateFertilizanteDto extends CreateProductoDto {
  @ApiProperty({
    ...
    enum: TipoProductos,
    example: TipoProductos.Fertilizantes,
  })
  ...
  @MinLength(5, {
    message:
      'Largo de la Composicion (NPK) debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(200, {
    message:
      'Largo de la Composicion (NPK) debe ser menor igual  de 200 caracteres',
  })
  ...
  @ApiProperty({
    ...
    enum: TipoFertizante,
    example: TipoFertizante.EQUILIBRADO_LIQUIDO,
  })
  ...
  @MinLength(5, {
    message:
      'Largo de la Frecuencia Aplicacion debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(200, {
    message:
      'Largo de la Frecuencia Aplicacion debe ser menor igual  de 200 caracteres',
  })
  ...
  @IsNotEmpty({
    message: 'La presentacion del fertilizante debe ser campo obligatorio',
  })
  @MinLength(5, {
    message:
      'Largo de la presentacion del fertilizante debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(100, {
    message:
      'Largo de la presentacion del fertilizante debe ser menor igual  de 100 caracteres',
  })
  ...
  @IsNotEmpty({
    message: 'Las observaciones del fertilizante debe ser campo obligatorio',
  })
  @MinLength(5, {
    message:
      'Largo de las observaciones del fertilizante debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(500, {
    message:
      'Largo de las observaciones del fertilizante debe ser menor igual  de 500 caracteres',
  })
