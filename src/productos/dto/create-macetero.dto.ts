...
export class CreateMaceteroDto extends CreateProductoDto {
  ...
  @Max(100, {
    message: 'El ancho del macetero debe serno puede ser mayor que 100 cm',
  })
  public ancho: number;
  @ApiProperty({
    name: 'peso',
  ...
  @Min(0.1, {
    message: 'El peso del macetero debe ser mayor igual a 0.1 kilos',
  })
  ...
  @Min(1, {
    message: 'La capacidad del macetero debe ser mayor igual a 1 litros',
  })
  @Max(100, {
    message: 'La capacidad del macetero debe ser menor igual a 100 litros',
  })
  ...
  @MaxLength(150, {
    message:
      'Largo del material del macetero de ser menor igual a 150 caracteres',
  })
  ...
  @MaxLength(100, {
    message: 'Largo del color del macetero de ser menor igual a 100 caracteres',
  })
  public color: string;
  @ApiProperty({
    description: 'Enum Tipo Producto',
    enum: FormaMacetero,
    example: FormaMacetero.Circular,
  })
  @IsEnum(FormaMacetero, {
    message: 'El valor debe ser una forma de macetero válida',
  })
