...
export class CreateControlPlagasDto extends CreateProductoDto {
  @ApiProperty({
    ...
    enum: TipoProductos,
    example: TipoProductos.ControlPlagas,
  })
  ...
  @ArrayNotEmpty({
    message: 'La lista plagas controladas no puede estar vacía',
  })
  @IsEnum(TipoPlaga, {
    each: true,
    message: 'El valor debe ser un tipo de plagan válido',
  })
  ...
  @MinLength(5, {
    message:
      'Largo de Composicion del plaglisida  debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(100, {
    message:
      'Largo de Composicion del plaglisida  debe ser menor igual  de 100 caracteres',
  })
  ...
  @ArrayNotEmpty({
    message: 'La lista metodos de aplicacion no puede estar vacía',
  })
  @IsEnum(MetodoAplicacion, {
    each: true,
    message: 'El valor debe ser un metodo de aplicacion válido',
  }) // Agregar "each: true"
  ...
  @MinLength(5, {
    message:
      'Largo de frecuencia Aplicacion  debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(100, {
    message:
      'Largo de frecuencia Aplicacion  debe ser menor igual  de 100 caracteres',
  })
  ...
  @ApiProperty({
    ...
    example:
      'Seguridad para mascotas, evitar el contacto directo con ojos y piel',
    required: true,
    type: 'string',
    minLength: 5,
    maxLength: 200,
  ...
  @IsNotEmpty({
    message: 'Las precauciones del plaguisida es campo obligatorio',
  })
  @MinLength(5, {
    message:
      'Largo de Las precauciones del plaguisida  debe ser mayor igual  de 5 caracteres',
  })
  @MaxLength(200, {
    message:
      'Largo de Las precauciones del plaguisida  debe ser menor igual  de 200 caracteres',
  })
