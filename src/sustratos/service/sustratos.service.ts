...
export class SustratosService {
  sustratos:Sustrato[]=[];
  constructor(){
   this.sustratos = [new Sustrato(29,'Mezcla para plantas de interior con perlita',['http://lugar.com/imagen_s1.png'],0,25000,['Arica a Pta.Arenas'],1500,'Ideal para plantas de interior que necesitan drenaje',TipoProductos.Sustratos,0,481,'SU1', [ComposicionSustrato.TURBA,ComposicionSustrato.PERLITA],	 [TexturaSustrato.LIGERO, TexturaSustrato.AIREADO], RetencionHumedad.MEDIA,TipoPlantasRecomendadas.PLANTAS_INTERIOR,'Ideal para plantas de interior que necesitan un buen equilibrio entre retención de humedad y drenaje'),
                     new Sustrato(30,'Sustrato con turba y perlita',	['http://lugar.com/imagen_s1.png'],0,25000,['Arica a Pta.Arenas'],1500,'Ideal para plantas de interior que necesitan drenaje',TipoProductos.Sustratos,0,481,'SU2',  [ComposicionSustrato.TURBA,ComposicionSustrato.PERLITA,ComposicionSustrato.VERMICULITA], [TexturaSustrato.LIGERO, TexturaSustrato.AIREADO],RetencionHumedad.ALTA,TipoPlantasRecomendadas.ORQUIDIAS ,'Plantas de interior con requerimientos moderados de humedad	Adecuado para plantas que requieren alta retención de humedad con buen drenaje.'),
                     new Sustrato(31,'Sustrato con turba y perlita',	['http://lugar.com/imagen_s1.png'],0,25000,['Arica a Pta.Arenas'],1500,'Ideal para plantas de interior que necesitan drenaje',TipoProductos.Sustratos,0,481,'SU2',  [ComposicionSustrato.TURBA,ComposicionSustrato.PERLITA,ComposicionSustrato.VERMICULITA], [TexturaSustrato.LIGERO, TexturaSustrato.AIREADO],RetencionHumedad.ALTA,TipoPlantasRecomendadas.PLANTAS_INTERIOR ,'Plantas de interior con requerimientos moderados de humedad	Adecuado para plantas que requieren alta retención de humedad con buen drenaje.')
                    ];
  }
  obtCantidad() {
