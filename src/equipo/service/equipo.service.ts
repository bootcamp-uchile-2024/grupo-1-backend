...
export class EquipoService {
  ...
  constructor() {
    this.equipo = [
      ...
      new Equipo('Mobile', 'María Elena Valencia', ['María Elena Valencia']),
    ];
  }
  private ecommerce = {
    nombre: 'Plantopía',
    ...
    tipo: 'E-commerce B2C',
    objetivoGeneral:
      'Construir una tienda intuitiva, diseñada para optimizar el tiempo y las necesidades del usuario.',
    objetivosEspecificos: [
      'Ampliar el acceso a la compra de insumos para plantas',
      'Facilitar la compra informada a través de búsquedas personalizadas.',
      'Ofrecer servicios de suscripción de mantenimiento.',
  ...
  getAreas(nombreArea?: string): Equipo[] {
    if (nombreArea) {
      return this.equipo.filter(
        (area) => area.nombreArea.toLowerCase() === nombreArea.toLowerCase(),
      );
    }
    return this.equipo;
  }
